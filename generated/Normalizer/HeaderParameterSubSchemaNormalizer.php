...
class HeaderParameterSubSchemaNormalizer implements DenormalizerInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (isset($data->{'minLength'})) {
            $value_35 = $data->{'minLength'};
            if (is_int($data->{'minLength'})) {
                $value_35 = $data->{'minLength'};
            } elseif (isset($data->{'minLength'})) {
                $value_35 = $data->{'minLength'};
            }
            $object->setMinLength($value_35);
        }
        ...
        if (isset($data->{'minItems'})) {
            $value_36 = $data->{'minItems'};
            if (is_int($data->{'minItems'})) {
                $value_36 = $data->{'minItems'};
            } elseif (isset($data->{'minItems'})) {
                $value_36 = $data->{'minItems'};
            }
            $object->setMinItems($value_36);
        }
