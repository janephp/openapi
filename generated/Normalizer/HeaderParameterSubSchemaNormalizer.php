...
class HeaderParameterSubSchemaNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (isset($data->{'enum'})) {
            $values_61 = array();
            foreach ($data->{'enum'} as $value_62) {
                $values_61[] = $value_62;
            }
            $object->setEnum($values_61);
        }
