...
class RaftNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Joli\\Jane\\OpenApi\\Tests\\Expected\\Model\\Raft') {
            return false;
        }
    ...
    {
        if ($data instanceof \Joli\Jane\OpenApi\Tests\Expected\Model\Raft) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Joli\Jane\OpenApi\Tests\Expected\Model\Raft();
