...
class ResourcesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Joli\\Jane\\OpenApi\\Tests\\Expected\\Model\\Resources') {
            return false;
        }
    ...
    {
        if ($data instanceof \Joli\Jane\OpenApi\Tests\Expected\Model\Resources) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Joli\Jane\OpenApi\Tests\Expected\Model\Resources();
        ...
        if (property_exists($data, 'BlkioWeightDevice')) {
            ...
            foreach ($data->{'BlkioWeightDevice'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Joli\\Jane\\OpenApi\\Tests\\Expected\\Model\\BlkioWeightDevice', 'json', $context);
            }
        ...
        if (property_exists($data, 'Ulimits')) {
            ...
            foreach ($data->{'Ulimits'} as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Joli\\Jane\\OpenApi\\Tests\\Expected\\Model\\Ulimits', 'json', $context);
            }
