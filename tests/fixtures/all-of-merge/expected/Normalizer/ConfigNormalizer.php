...
class ConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Joli\\Jane\\OpenApi\\Tests\\Expected\\Model\\Config') {
            return false;
        }
    ...
    {
        if ($data instanceof \Joli\Jane\OpenApi\Tests\Expected\Model\Config) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Joli\Jane\OpenApi\Tests\Expected\Model\Config();
