...
class MountVolumeOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Joli\\Jane\\OpenApi\\Tests\\Expected\\Model\\MountVolumeOptions') {
            return false;
        }
    ...
    {
        if ($data instanceof \Joli\Jane\OpenApi\Tests\Expected\Model\MountVolumeOptions) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Joli\Jane\OpenApi\Tests\Expected\Model\MountVolumeOptions();
        ...
        if (property_exists($data, 'DriverConfig')) {
            $object->setDriverConfig($this->denormalizer->denormalize($data->{'DriverConfig'}, 'Joli\\Jane\\OpenApi\\Tests\\Expected\\Model\\MountVolumeOptionsDriverConfig', 'json', $context));
        }
