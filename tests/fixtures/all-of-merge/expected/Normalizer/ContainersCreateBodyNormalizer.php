...
class ContainersCreateBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Joli\\Jane\\OpenApi\\Tests\\Expected\\Model\\ContainersCreateBody') {
            return false;
        }
    ...
    {
        if ($data instanceof \Joli\Jane\OpenApi\Tests\Expected\Model\ContainersCreateBody) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Joli\Jane\OpenApi\Tests\Expected\Model\ContainersCreateBody();
        ...
        if (property_exists($data, 'Healthcheck')) {
            $object->setHealthcheck($this->denormalizer->denormalize($data->{'Healthcheck'}, 'Joli\\Jane\\OpenApi\\Tests\\Expected\\Model\\HealthConfig', 'json', $context));
        }
        ...
        if (property_exists($data, 'Volumes')) {
            $object->setVolumes($this->denormalizer->denormalize($data->{'Volumes'}, 'Joli\\Jane\\OpenApi\\Tests\\Expected\\Model\\ConfigVolumes', 'json', $context));
        }
        ...
        if (property_exists($data, 'NetworkingConfig')) {
            $object->setNetworkingConfig($this->denormalizer->denormalize($data->{'NetworkingConfig'}, 'Joli\\Jane\\OpenApi\\Tests\\Expected\\Model\\ContainersCreateBodyNetworkingConfig', 'json', $context));
        }
