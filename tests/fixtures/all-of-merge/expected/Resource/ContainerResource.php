...
{
    /**
     * @param \Joli\Jane\OpenApi\Tests\Expected\Model\ContainersCreateBody $body       Container to create
     ...
     */
    public function containerCreate(\Joli\Jane\OpenApi\Tests\Expected\Model\ContainersCreateBody $body, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
